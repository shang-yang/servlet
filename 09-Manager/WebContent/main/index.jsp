...
<body>
    ...
    <div class="mainindex">    
    	<div class="welinfo">
	    	...
	    	<b>Admin早上好，欢迎使用信息管理系统</b>(admin@shangyang.com)
	    	<a href="#">帐号设置</a>
   		 </div>  
	    <div class="welinfo">
    	...
    	<div class="xline"></div>
   		<div class="uimakerinfo"><b>查看shangyang网站使用指南，您可以了解到多种风格的B/S后台管理界面,软件界面设计，图标设计，手机界面等相关信息</b>(<a href="http://www.uimaker.com" target="_blank">www.uimaker.com</a>)</div>
	    <ul class="umlist">
